  ...
  return (
    ...
    <div class="user-blog">
      <div class="user-blog__header">
        <div class="user-blog__header-photo">
          <img src={user1} class="responsive avatar" alt="" />
        </div>
        <h1 class="user-blog__header-title">Chris Hudson</h1>
        <p class="user-blog__header-bio">
      ...
      <div class="user-blog__posts">
        <div class="user-blog__posts-item">
          ...
          <div class="user-blog__posts-date">
        ...
        <div class="user-blog__posts-item">
          ...
          <div class="user-blog__post-content">
